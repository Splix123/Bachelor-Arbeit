...
\newcommand{\hsmatitelde}{Titel}

% Titel der Arbeit auf Englisch
\newcommand{\hsmatitelen}{Title}

% Weitere Informationen zur Arbeit
\newcommand{\hsmaort}{Mannheim}          % Ort
\newcommand{\hsmaautorvname}{Moritz}        % Vorname(n)
\newcommand{\hsmaautornname}{Rühm} % Nachname(n)
\newcommand{\hsmaabgabedatum}{2026-00-00}% Datum der Abgabe in dem Format JJJJ-MM-TT
...
\newcommand{\hsmazweitkorrektor}{Erika Mustermann, Technische Hochschule Mannheim}   % Betreuer im Unternehmen oder Zweitkorrektor
